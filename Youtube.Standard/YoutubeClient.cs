// <copyright file="YoutubeClient.cs" company="APIMatic">
// Copyright (c) APIMatic. All rights reserved.
// </copyright>
namespace Youtube.Standard
{
    using System;
    ...
    using Youtube.Standard.Controllers;
    ...
    /// </summary>
    public sealed class YoutubeClient : IConfiguration
    {
        ...
        /// <summary>
        /// Creates an object of the YoutubeClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> YoutubeClient.</returns>
        internal static YoutubeClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("YOUTUBE_STANDARD_ENVIRONMENT");
        ...
        {
            private Environment environment = Youtube.Standard.Environment.Production;
